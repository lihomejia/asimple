								...
								<table style="width:100%;">
									<tr>
										...
										<td style="text-align:right">
											<input type="button" class="btnStyle" value="&nbsp;新&nbsp;建&nbsp;" onclick="window.location.href='<c:url value="/pesticide/resource/add.html?type=${type}"/>';"/>
										</td>
									</tr>
									<tr>
										<td>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="dataList">
									...
									<c:forEach items="${datas}" var="data">
										<tr>
											...
											<td>
												<a class=linkStyle href="pesticide/resource/entry.html?type=${type}&resourceId=${data.resource_id}">修改</a>
												&nbsp;|&nbsp;
												<a class=linkStyle href="pesticide/resource/delete.html?type=${type}&resourceId=${data.resource_id}" onclick="return confirm('确定删除吗?');">删除</a>
											</td> 
										</tr>
									</c:forEach>
								</table>
