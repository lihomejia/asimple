			...
			<tr>
				<td>
					<table border="0" cellspacing="0" cellpadding="0" class="subNav mCenter" style="width:100%;">
			      		<tr>
			        		<td class="font12Blue p10"><span class="font12Blue_B">您当前所在位置：肥料种类维护</td>
			      		</tr>
			   		 </table>
				</td>
			</tr>
								...
								<table style="width:100%;">
									<tr>
										...
										<td style="text-align:right">
											<input type="button" class="btnStyle" value="&nbsp;新&nbsp;建&nbsp;" onclick="window.location.href='add.html?type=5';"/>
										</td>
									</tr>
									<tr>
										<td>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="dataList">
									...
									<c:forEach items="${datas}" var="data">
										<tr>
											...
											<td>
												<a class=linkStyle href="manure/resource/entry.html?type=5&resourceId=${data.resource_id}">修改</a>
												&nbsp;|&nbsp;
												<a class=linkStyle href="manure/resource/delete.html?type=5&resourceId=${data.resource_id}" onclick="return deleteConfirm();">删除</a>
											</td> 
										</tr>
									</c:forEach>
								</table>
