			...
			<tr>
				<td>
					<table border="0" cellspacing="0" cellpadding="0" class="subNav mCenter" style="width:100%;">
			      		<tr>
			        		<td class="font12Blue p10"><span class="font12Blue_B">您当前所在位置：肥料规格维护</td>
			      		</tr>
			   		 </table>
				</td>
			</tr>
								...
								<table style="width:100%;">
									<tr>
										...
										<td style="text-align:right">
											<input type="button" class="btnStyle" value="&nbsp;新&nbsp;建&nbsp;" onclick="window.location.href='add.html?type=2';"/>
										</td>
									</tr>
									<tr>
										<td>
			...
			<tr>
				<td>
					<table cellpadding="0" cellspacing="0" style="width:100%;">
						...
						<tr>
         					 <td class="dataListTitle"><span class="pl10">肥料规格维护</span></td>
       					</tr>
						<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0" class="dataList">
									...
									<c:forEach items="${datas}" var="data">
										<tr>
											...
											<td>
												<a class=linkStyle href="manure/resource/entry.html?type=2&resourceId=${data.resource_id}">修改</a>
												&nbsp;|&nbsp;
												<a class=linkStyle href="manure/resource/delete.html?type=2&resourceId=${data.resource_id}" onclick="return deleteConfirm();">删除</a>
											</td> 
										</tr>
									</c:forEach>
								</table>
