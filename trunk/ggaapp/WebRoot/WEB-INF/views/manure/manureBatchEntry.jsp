...
<head>
    ...
    <script type="text/javascript">
		...
		function doCancel() {
			window.location.href = "list.html?type=3";
		}
    </script>
</head>
<body>
	<form id="form1" method="post" action="manure/resource/save.html">
		...
		<input type="hidden" name="data['resource_cate']" value="1"/>
		<input type="hidden" name="data['resource_type']" value="3"/>
						...
						<tr>
							<td>
								<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="dataList">
									<tr>
										<td class=forumrow style="30%"><div align="right">肥料生产批号:</div></td>
										<td class=forumrow>
