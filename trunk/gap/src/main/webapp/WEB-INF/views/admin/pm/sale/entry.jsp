...
<head>
    ...
    <script type="text/javascript">
		JGAP.on(window, 'load', function() {
            ...
            validator.regist({id : "product", name : "产品名称"}, "notnull");
							...
							<td>
								<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="dataList">
                                    ...
                                    <tr> 
                                        ...
                                        <td class=forumrow>
                                            <input type="text" id="product" name="product" value="${data.product}" /><font class=required>*</font>
                                        </td>
                                    ...
                                    <tr> 
                                        ...
                                        <td class=forumrow>
                                            <input type="text" id="purchaser" name="purchaser" value="${data.purchaser}" />
                                        </td>
