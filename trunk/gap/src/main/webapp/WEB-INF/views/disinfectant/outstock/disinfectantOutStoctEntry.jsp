...
<head>
    ...
    <script type="text/javascript">
    	JGAP.on(window, 'load', function() {
	   	...
	   	function subform2(flag) {
        	...
        	if (typeof(form._onsubmit) == "function" && !form._onsubmit() 
       		...
       		$.ajax({
			   type: "POST",
			   url: "<%=basePath%>disinfectant/outstock/checkOutStock.html",
        ...
        function doStockList() {
			var record = window.showModalDialog("<%=basePath%>disinfectant/stock/select/list.html", '', 'dialogWidth:650px; dialogHeight:400px; edge:Raised; center:yes; help:no; status:no;scroll=no;');
			if (!record) return;
