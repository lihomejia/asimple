									...
									<tr>
				              		...
				              		<c:forEach items="${datas}" var="data" varStatus="status">
				              			<tr>
							                ...
							                <td><a href="<%=basePath%>disinfectant/instock/list.html?stockId=${data.id}">入库记录</a></td>
							                <td><a href="<%=basePath%>disinfectant/outstock/list.html?stockId=${data.id}">出库记录</a></td>
							                <td></td>
						              	</tr>
						        	</c:forEach>
								</table>
