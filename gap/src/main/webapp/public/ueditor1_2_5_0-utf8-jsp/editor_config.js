...
(function () {
    ...
    URL = window.basePath + 'public/ueditor1_2_5_0-utf8-jsp/';//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[
            ['source','fullscreen','undo', 'redo', '|', 'superscript', 'subscript',
