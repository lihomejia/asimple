...
<head>
    ...
    <script type="text/javascript">
        ...
        function doStockList() {
			var record = window.showModalDialog("<%=basePath%>pesticide/stock/select/list.html", '', 'dialogWidth:650px; dialogHeight:400px; edge:Raised; center:yes; help:no; status:no;scroll=no;');
			if (!record) return;
