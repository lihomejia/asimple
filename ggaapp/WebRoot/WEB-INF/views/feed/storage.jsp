				...
				<td width="790" align="left" valign="top" class="pl10">
					<form name="form1" method="post" action="<c:url value='/feed/resource/edit.html'/>" onsubmit="return formCheck();">
					  <table cellpadding="2" cellspacing="1" border="0" width="95%" class="tableBorder" align=center>
					    ...
					    <tr bgcolor=ffffff> 
					      <td width="12%" class=forumrow><div align="right">饲料名称：</div></td>
					      ...
					      <td width="27%" class=forumrow><input name="ruku_date" onfocus="calendar()" size="25" /></td>
					    </tr>
					    <tr  bgcolor=ffffff> 
					      <td width="12%" class=forumrow><div align="right">规格/型号：</div></td>
					      <td width="45%" class=forumrow>
					      ...
					      <td width="16%" class=forumrow><div align="right">所属类别：</div></td>
					      <td width="27%" class=forumrow><select name="leibie" id="leibie">
					    ...
					    <tr  bgcolor=ffffff> 
					      <td width="12%" class=forumrow><div align="right">生产批号：</div></td>
					      <td width="45%" class=forumrow>
					      ...
					      <td width="16%" class=forumrow><div align="right">有效期：</div></td>
					      <td width="27%" class=forumrow><input name="youxiaoqi" onfocus="calendar()" size="25" /></td>
					    </tr>
					    <tr  bgcolor=ffffff> 
					    <td width="12%" class=forumrow><div align="right">生产商：</div></td>
					      <td width="45%" class=forumrow>
					      ...
					      <td width="16%" class=forumrow><div align="right">供应商：</div></td>
					      <td width="27%" class=forumrow><input name="gongyingsh" type="text" id="pname" size="25" maxlength="30" /></td>
					    </tr>
					    <tr  bgcolor=ffffff> 
					    ...
					    <tr  bgcolor=ffffff> 
					      <td width="12%" class=forumrow><div align="right">产地：</div></td>
					      <td width="45%" class=forumrow><input name="chandi" type="text" id="pname" size="25" maxlength="30"></td>
					      <td width="16%" class=forumrow><div align="right">包装形式：</div></td>
					      <td width="27%" class=forumrow><input name="baozhuang" type="text" id="pname" size="25" maxlength="30" /> </td>
					    </tr>
					   <tr  bgcolor=ffffff> 
					      <td width="12%" class=forumrow><div align="right">有效成分：</div></td>
					      <td width="45%" class=forumrow><input name="youxiaochf" type="text" id="pname" size="25" maxlength="30" /></td>
					      <td width="16%" class=forumrow><div align="right">入库人：</div></td>
					      <td width="27%" class=forumrow><input name="rukuren" type="text" id="pname" size="25" maxlength="30" value=杜云浩 /> </td>
					    </tr>
					    <tr  bgcolor=ffffff> 
					      <td rowspan="2" class=forumrow><div align="right">备注：</div></td>
					      <td colspan="3" class=forumrow><textarea name="beizhu" cols="80" rows="10" id="beizhu"></textarea></td>
					    </tr>
					    <tr  bgcolor=ffffff> 
